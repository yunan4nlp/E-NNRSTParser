...
class DisParser(object):
    ...
    def encode(self, batch_input_ids, batch_token_type_ids, batch_attention_mask, edu_lengths):
        if self.use_cuda:
            batch_input_ids = batch_input_ids.cuda()
            batch_token_type_ids = batch_token_type_ids.cuda()
            batch_attention_mask = batch_attention_mask.cuda()

        bert_represents = self.global_encoder(batch_input_ids, batch_token_type_ids, batch_attention_mask)
